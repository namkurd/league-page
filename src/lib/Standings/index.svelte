<script>
    ...
    const sortOrder = ["divisionTies", "divisionWins", "fptsAgainst", "fpts", "ties", "wins"];

    // Column order from left to right
    const columnOrder = [{name: "W", field: "wins"}, {name: "L", field: "losses"}, {name: "T", field: "ties"}, {name: "Streak", field: "streak"}, {name: "FPTS", field: "fpts"}, {name: "FPTS Against", field: "fptsAgainst"}, ]
